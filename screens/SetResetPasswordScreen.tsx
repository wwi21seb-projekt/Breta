...
const SetResetPasswordScreen = () => {
    // State variables for managing input values, errors, and form validity
    ...
    const [confirmNewResetPasswordErrorText, setConfirmNewResetPasswordErrorText] = useState("");
    ...
    // Render success message if the password is reset successfully
    else if (isReseted) {
        return (
    ...
    // Render form if no errors and password is not yet reset
    else {
        return (
