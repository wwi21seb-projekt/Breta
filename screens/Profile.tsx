...
const Profile = () => {
  ...
  if (notAuthorized) {
    return <View style={styles.errorContainer}>
      ...
      <TouchableOpacity style={styles.errorButton} onPress={() => navigation.navigate("Authentification" as never)}>Anmelden</TouchableOpacity>
    </View>;
  }
  ...
  />
        ...
        <View style={styles.header}>
          <View style={styles.userInfo}>
            ...
            <Text style={{fontSize: SIZES.medium, color: COLORS.darkgray, marginBottom: '3%'}}>@{username}</Text>
